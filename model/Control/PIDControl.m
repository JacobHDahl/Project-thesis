function [deltaT, deltaE] = PIDControl(eta, nu, ConstStruct, Va_target, height_target)
...
deltaE_min = -deg2rad(30);
deltaE_max = deg2rad(30);
...
W_h = 10; %Bandwidth multiplier. Tunable.
zeta_h = 1; %Damping. Tunable
omega_n_h = (1/W_h)*omega_n_theta;

Ki_h = 0*0.01*(omega_n_h^2)/(KDC_theta*Va);
...
theta_target = alpha_trim;%Kp_h * height_error + Ki_h*height_error_integrated;
